...
<!-- 임시로 히든 처리 -->
<div class="hidden flex items-center min-h-screen p-6 bg-gray-50 dark:bg-gray-900">
  <div
        ...
        <div class="w-full">
          ...
          <div class="flex mt-6 text-sm">
            <label class="flex items-center dark:text-gray-400">
              <input
                type="checkbox"
                class="border-2 border-indigo-500/30 text-purple-600 form-checkbox focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
              />
              <span class="ml-2">
                <span class="underline">개인정보 이용 및 수집</span>
                <span>에 동의합니다.</span>
              </span>
            </label>
          </div>
...
// const error_message = ref('대문자, 소문자, 숫자, 특수문자를 포함하여 8자 이상 입력.')
